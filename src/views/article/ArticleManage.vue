...
<template>
    <el-card class="page-container">
        ...
        <el-table :data="articles" style="width: 100%">
            ...
            <el-table-column label="发表时间" prop="createTime" :formatter="dateFormat"> </el-table-column>
        ...
        <el-drawer v-model="visibleDrawer" :title="title" direction="rtl" size="50%">
            ...
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item>
                    <el-button type="primary" @click="title =='添加文章'?addArticle('已发布'):editArticle('已发布')">发布</el-button>
                    <el-button type="info" @click="title =='添加文章'?addArticle('草稿'):editArticle('草稿')">草稿</el-button>
                </el-form-item>
            </el-form>
        </el-drawer>
    </el-card>
